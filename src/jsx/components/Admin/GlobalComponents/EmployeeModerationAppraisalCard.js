...
const EmployeeModerationAppraisalCard = (props) => {
  ...
  return (
    <>
      ...
      <BreadCrumb props={props} backlink={"employee-moderation"}/>
...
export default withRouter(EmployeeModerationAppraisalCard);
