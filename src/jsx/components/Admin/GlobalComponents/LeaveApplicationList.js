...
function LeaveApplicationList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/leave/getleaveapplicationlist`,
        config
      )
      .then((result) => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: "Days Applied",
        accessor: "daysApplied",
      },
      {
        Header: "Days Approved",
        accessor: "daysApproved",
      },
      {
        Header: "Start Date",
  ...
  return (
    <>
      <DataTable columns={columns} data={data} setSelection={setSelection} props={props} />
    </>
  );
}
export default withRouter(LeaveApplicationList);
