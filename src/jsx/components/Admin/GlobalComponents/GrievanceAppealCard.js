...
const GrievanceAppealCard = (props) => {
  ...
  if (props.location.state[0].datum[0].progressNo === 3) {
  ...
  } else if (props.location.state[0].datum[0].progressNo === 2) {
    CycleTwoEntries = true;
    GeneralRemarkTextAreaField = "col-xl-12 col-sm-12 d-none";
    GeneralRemarListDisp = "col-xl-12 col-sm-12";
    Approve = (
  ...
  } else if (props.location.state[0].datum[0].progressNo === 4) {
    CycleTwoEntries = true;
    GeneralRemarkTextAreaField = "col-xl-12 col-sm-12 d-none";
    GeneralRemarListDisp = "col-xl-12 col-sm-12";
    DisplayCycleTwoValue = "card-body";
    DisplayCycleTwoFields = "card-body escalated d-none";
    AppealTextsection = "card-body appeal";
    Approve = (
      <>
        <button className="btn btn-warning" onClick={ApproveFn}>
          Mark as Resolved <i className="fa fa-arrow-up"></i>
        </button>
        <button className="btn btn-danger ml-1" onClick={MakeAnAppealFn}>
          Make An Appeal <i className="fa fa-arrow-right"></i>
        </button>
      </>
    );
...
export default withRouter(GrievanceAppealCard);
