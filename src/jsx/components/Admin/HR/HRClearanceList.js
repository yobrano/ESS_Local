...
function HRClearanceList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/home/hrgetclearancelist`,
        config
      )
      .then((result) => {
        // =>console.log(result.data.clearanceList);
        setData(result.data.clearanceList);
      })
      .catch((err) => {
        console.log(err);
      })
  ...
  const columns = useMemo(
    () => [
      ...
      // {
      //   Header: "HR Name",
      //   accessor: "hrApprovedName",
      
      // },

      // {
      //   Header: "Admin Approved",
      //   accessor: "hodAdminApproved",
      //   Filter: SelectColumnFilter,
      //   filter: "includes",
      // },
      // {
      //   Header: "Admin Name",
      //   accessor: "hodAdminApprovedName",
      
      // },

      // {
      //   Header: "IT Approved",
      //   accessor: "hoditApproved",
      //   Filter: SelectColumnFilter,
      //   filter: "includes",
      // },
      // {
      //   Header: "IT Name",
      //   accessor: "hoditApprovedName",
      
      // },

      // {
      //   Header: "FIN Approved",
      //   accessor: "hodfinApproved",
      //   Filter: SelectColumnFilter,
      //   filter: "includes",
      // },
      // {
      //   Header: "FIN Name",
      //   accessor: "hodfinApprovedName",
      ...
      //         <span class="action-btn">Pending HOD Approval</span>
      //       </button>
      //     `;
      //     } else if (value === 2) {
      //       buttvar[0] = `
      //       <button disabled class="btn btn-warning">
      //         <span class="action-btn">Pending HOD-Admin</span>
      //       </button>
      //     `;
      //     } else if (value === 3) {
      //       buttvar[0] = `
      //       <button disabled class="btn btn-warning">
      //         <span class="action-btn">Pending HOD-IT</span>
      //       </button>
      //     `;
      //     } else if (value === 4) {
      //       buttvar[0] = `
      //       <button disabled class="btn btn-warning">
      //         <span class="action-btn">Pending HOD-HR</span>
      //       </button>
      //     `;
      //     }
      //     else if (value === 5) {
      //       buttvar[0] = `
      //       <button disabled class="btn btn-warning">
      //         <span class="action-btn">Pending HOD-FIN</span>
      //       </button>
      //     `;
      //     }
      //     else if (value === 6) {
      ...
      //         <span class="action-btn">Pending HR Approval</span>
      //       </button>
      //     `;
      //     }
      //     else if (value === 7) {
      ...
      //     return buttvar.map((d, k) => {
      //       return <Markup content={d} key={k} />;
      //     });
      //   },
      // },
    ],
  ...
  if (selection.length === 1) {
    ...
    props.history.push("/HR-clearance-card", [{ datum: selection }]);
  }
...
export default withRouter(HRClearanceList);
