...
const HRProbationCard = (props) => {
  ...
  //Probation Related Action; during HR approval
  //F=Flag
    ...
    swal({
      ...
      .then((willCreate) => {
        if (willCreate) {
          setDisableBtn(true)
          return axios.post(
            `${process.env.REACT_APP_API_S_LINK}/endofmonitoringandcontract/hrpushtomdfd/${props.location.state[0].datum[0].probationNo}`,
            data,
            config
          );
        }
  ...
  const HRApprovedProbation = (e)=>{
    ...
    swal({
      title: "Are you sure?",
      text: "Are you sure that you want to Approve Probation",
      icon: "warning",
      dangerMode: true,
    })
      .then((willCreate) => {
        if (willCreate) {
          setDisableBtn(true)
          return axios.get(
            `${process.env.REACT_APP_API_S_LINK}/endofmonitoringandcontract/hrapproveprobation/${props.location.state[0].datum[0].probationNo}`,
            // data,
            config
          );
        }
