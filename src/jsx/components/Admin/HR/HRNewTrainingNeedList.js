...
function HRNewTrainingNeedList(props) {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${process.env.REACT_APP_API_S_LINK}/training/gettrainingneedshr`, config)
      .then((result) => {
...
export default withRouter(HRNewTrainingNeedList);
