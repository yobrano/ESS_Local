...
function HRUserList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/home/hrallusers`,
        config
      )
      .then((result) => {
  ...
  if (selection.length === 1) {
    ...
    props.history.push("/HR-user-card", [{ datum: selection }]);
  }
...
export default withRouter(HRUserList);
