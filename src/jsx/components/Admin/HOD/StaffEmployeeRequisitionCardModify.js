...
const StaffEmployeeRequisitionCardModify = (props) => {
  ...
  const pushToHR = (e) => {
    ...
    swal({
      title: "Are you sure?",
      text: "Are you sure that you want to Push to HOD",
      icon: "warning",
      dangerMode: true,
  ...
  if (progressLevel === 0) {
    actionButtn = (
      ...
      >
        Push to HOD <i className="fa fa-user-o"></i>
      </button>
    );
...
export default withRouter(StaffEmployeeRequisitionCardModify);
