...
function HODFINClearanceList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/home/hodfingetrespectivelist`,
        config
      )
      .then((result) => {
  ...
  if (selection.length === 1) {
    ...
    props.history.push("/HOD-finance-clearance-card", [{ datum: selection }]);
  }
...
export default withRouter(HODFINClearanceList);
