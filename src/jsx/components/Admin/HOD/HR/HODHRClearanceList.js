...
function HODHRClearanceList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/home/hodhrgetrespectivelist`,
        config
      )
      .then((result) => {
  ...
  if (selection.length === 1) {
    ...
    props.history.push("/HOD-HR-clearance-card", [{ datum: selection }]);
  }
...
export default withRouter(HODHRClearanceList);
