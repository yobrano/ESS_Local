...
function HODClearanceList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/home/hodgetrespectivelist`,
        config
      )
      .then((result) => {
  ...
  if (selection.length === 1) {
    ...
    props.history.push("/clearance-card", [{ datum: selection }]);
  }
...
export default withRouter(HODClearanceList);
