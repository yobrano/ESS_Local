...
function NewTrainingNeedHODList(props) {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${process.env.REACT_APP_API_S_LINK}/training/gettrainingneedshod`, config)
      .then((result) => {
      ...
      },
      {
        ...
        Cell: ({ value }) => {
          ...
          `;
            ...
            <span class="action-btn">Under HR > </span>
          </button>
          `;
          } else if (value === 3) {
            buttvar[0] = `
            <button disabled class="btn btn-warning">
              <span class="action-btn">Under MD/FD > </span>
            </button>
          `;
          }
          else if (value === 4) {
          ...
          `;
            ...
            buttvar[0] = `
            <button disabled class="btn btn-success">
              <span class="action-btn"> << Under HOD</span>
            </button>
          `;
          }
  ...
  if (selection.length === 1) {
    ...
    if (selection[0].needNo !== undefined) {
      ...
      //   }}
      // />;
      props.history.push("/update-need", [{ datum: selection }]);
    }
  }
...
export default withRouter(NewTrainingNeedHODList);
