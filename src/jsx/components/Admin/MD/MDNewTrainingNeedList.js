...
function MDNewTrainingNeedList(props) {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${process.env.REACT_APP_API_S_LINK}/training/gettrainingneedsmd`, config)
      .then((result) => {
...
export default withRouter(MDNewTrainingNeedList);
