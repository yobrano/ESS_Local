...
function BucketContractList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/endofmonitoringandcontract/gethrspecializedbucketlist`,
        config
      )
      .then((result) => {
...
export default withRouter(BucketContractList);
