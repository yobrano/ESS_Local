...
function BucketProbationList(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/endofmonitoringandcontract/gethrprobationbucketlist`,
        config
      )
      .then((result) => {
...
export default withRouter(BucketProbationList);
