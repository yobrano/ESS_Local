...
function BucketProbationListHOD(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/endofmonitoringandcontract/gethodprobationbucketlist`,
        config
      )
      .then((result) => {
...
export default withRouter(BucketProbationListHOD);
