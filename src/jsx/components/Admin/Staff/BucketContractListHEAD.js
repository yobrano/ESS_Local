...
function BucketContractListHEAD(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/endofmonitoringandcontract/getheadstandardbucketlist`,
        config
      )
      .then((result) => {
...
export default withRouter(BucketContractListHEAD);
