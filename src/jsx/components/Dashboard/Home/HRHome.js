...
const HRHome = () => {
  const [applicants, setApplicatants] = useState(0);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_S_LINK}/home/adminstats`,
        config
      )
      .then((result) => {
  ...
  return (
    <Fragment>
      ...
      <div className="row d-none">
            ...
            <div className="card-header media border-0 pb-0">
              <div className="media-body">
                <h2 className="text-black">
                  {applicants} <span className="text-success fs-14">+</span>
                </h2>
                <p className="mb-0 text-black">Job Applicants</p>
              </div>
              <svg
                width="55"
                height="53"
        ...
        <div className="col-xl-3 col-lg-6 col-sm-6">
          <Link className="" to="/approved-applicants" style={{textDecoration:'none',}}>
          <div className="card overflow-hidden">
            <div className="card-header media border-0 pb-0">
              <div className="media-body">
                <h2 className="text-black">
                ...
                <p className="mb-0 text-black">Viewed Applicants</p>
              </div>
              <svg
                width="55"
                height="53"
