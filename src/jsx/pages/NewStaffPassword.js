...
function NewStaffPassword(props) {
  ...
  const onRequest = (e)=>{
    ...
    // const errorObj = { ...errorsObj };
    // if (staffid === "") {
    //   errorObj.email = "Employee No is Required";
    //   error = true;
    // }
                      ...
                      <form>
                        <div className="form-group">
                          <label className="mb-2 ">
                            <strong className="text-white">Employee Number</strong>
                          </label>
                          {/* <input
                            type="text"
...
export default NewStaffPassword;
// export default connect(mapStateToProps)(NewStaffPassword);
