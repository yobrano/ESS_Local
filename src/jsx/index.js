...
const Markup = () => {
  ...
  const routes3 = [
    ...
    { url: "GrievanceList", component:GrievanceList, usr: "HOD" },
    { url: "GrievanceCard", component:GrievanceCard, usr: "HOD" },
  ...
  const routes6 = [
    ...
    { url: "GrievanceList", component:GrievanceList, usr: "HOD-ADMIN" },
    { url: "GrievanceCard", component:GrievanceCard, usr: "HOD-ADMIN" },
  ...
  const routes7 = [
    ...
    { url: "GrievanceList", component:GrievanceList, usr: "HOD-ICT" },
    { url: "GrievanceCard", component:GrievanceCard, usr: "HOD-ICT" },
  ...
  const routes8 = [
    ...
    { url: "GrievanceList", component:GrievanceList, usr: "HOD-HR" },
    { url: "GrievanceCard", component:GrievanceCard, usr: "HOD-HR" },
  ...
  const routes9 = [
    ...
    { url: "GrievanceList", component:GrievanceList, usr: "HOD-FIN" },
    { url: "GrievanceCard", component:GrievanceCard, usr: "HOD-FIN" },
  ...
  const routes11 = [
    ...
    { url: "GrievanceList", component:GrievanceList, usr: "NOS" },
    { url: "GrievanceCard", component:GrievanceCard, usr: "NOS" },
  ...
  const routes4 = [
    ...
    { url: "GrievanceList", component:GrievanceList, usr: "MD" },
    { url: "GrievanceCard", component:GrievanceCard, usr: "MD" },
